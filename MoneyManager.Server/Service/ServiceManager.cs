...
namespace MoneyManager.Server.Service
{
    public class ServiceManager : IServiceManager
    {
        ...
        private readonly Lazy<IUserWalletService> _userWalletService;
        ...
        public ServiceManager(IRepositoryManager repositoryManager, ILoggerManager logger, IMapper mapper)
        {
            ...
            _userWalletService = new Lazy<IUserWalletService>(() => new UserWalletService(repositoryManager, logger, mapper));
        ...
        public IUserWalletService UserWalletService => _userWalletService.Value;
